...
| **Status** | Lead / Qualification / Negotiation / Won / Lost. |

## Step by step

1. **Proposals → + Proposal**.
2. Choose the **client** (sets VAT and discount).
3. Fill in the **title** and **validity**.
4. Add the **[catalogue lines](linhas.md)**.
5. **Save**.
