...
<video class="iefp-video" controls preload="metadata" playsinline poster="/manual/assets/screens/dashboard.png"><source src="/manual/assets/videos/dashboard-en.mp4" type="video/mp4"></video>
